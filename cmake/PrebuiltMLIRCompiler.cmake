...
#
# kernel-tv is the top-level project; each language backend is enabled by
...
# kernel_tv_read_cmake_cache(<build-dir> <cache-var> <out-var>)
#
...
function(kernel_tv_read_cmake_cache build_dir key out_var)
...
# kernel_tv_resolve_input(<name> <doc>)
#
...
macro(kernel_tv_resolve_input name doc)
...
# kernel_tv_find_mlir(<llvm-syspath>)
#
...
macro(kernel_tv_find_mlir llvm_syspath)
...
# kernel_tv_ninja_includes(<build-dir> <object-path> <out-var>)
#
...
function(kernel_tv_ninja_includes build_dir object out_var)
  set(${out_var} "" PARENT_SCOPE)
