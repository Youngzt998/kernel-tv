...
// builder/mlir — map an MLIR scalar type to the neutral kernel_tv::DType.
...
// Any scalar mlir::Type -> kernel_tv::DType.
...
// pointee.)
kernel_tv::DType dtypeOf(mlir::Type type);

// mlir::FloatType -> kernel_tv::DType.
kernel_tv::DType dtypeOf(mlir::FloatType type);
