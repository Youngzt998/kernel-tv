...
kernel_smt::DType Semantics::dtypeOf(mlir::Type type) {
  if (auto intTy = llvm::dyn_cast<mlir::IntegerType>(type)) {
    switch (intTy.getWidth()) {
    case 1:
      return kernel_smt::DType::I1;
    case 8:
      return kernel_smt::DType::I8;
    case 16:
      return kernel_smt::DType::I16;
    case 32:
      return kernel_smt::DType::I32;
    case 64:
      return kernel_smt::DType::I64;
    default:
  ...
  if (llvm::isa<mlir::triton::PointerType>(type))
    return kernel_smt::DType::Ptr;
  llvm_unreachable("dtypeOf: unsupported mlir::Type");
}

kernel_smt::DType Semantics::dtypeOf(mlir::FloatType type) {
  if (llvm::isa<mlir::Float16Type>(type))
    return kernel_smt::DType::F16;
  if (llvm::isa<mlir::BFloat16Type>(type))
    return kernel_smt::DType::BF16;
  if (llvm::isa<mlir::Float32Type>(type))
    return kernel_smt::DType::F32;
  if (llvm::isa<mlir::Float64Type>(type))
    return kernel_smt::DType::F64;
